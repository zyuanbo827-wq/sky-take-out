...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    public BusinessDataVO getBusinessData(LocalDateTime begin, LocalDateTime end) {
        ...
        map.put("begin",begin);
        map.put("end",end);
        LocalDateTime startTime = begin.with(LocalTime.MIN);
        LocalDateTime endTime = end.with(LocalTime.MAX);
        //查询总订单数
        Integer totalOrderCount = orderMapper.countOrder(map);

        map.put("status", Orders.COMPLETED);
        //营业额
        Double turnover = orderMapper.sumByMap(startTime, endTime, Orders.COMPLETED); //
